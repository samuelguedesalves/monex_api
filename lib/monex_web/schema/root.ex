defmodule MonexWeb.Schema.Root do
  use Absinthe.Schema.Notation

  alias MonexWeb.Middlewares.Authentication
  alias MonexWeb.Resolvers.Operations, as: OperationsResolver
  alias MonexWeb.Resolvers.User, as: UsersResolver

  # custom types
  import_types MonexWeb.Schema.Types.Custom.UUID4
  import_types MonexWeb.Schema.Types.Custom.DateTime

  # schemas
  import_types MonexWeb.Schema.Users
  import_types MonexWeb.Schema.Operations
